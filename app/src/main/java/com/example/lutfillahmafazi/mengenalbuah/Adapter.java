...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    //TODO 2 Membuat construktor untuk variable yang sudah kita buat agar dapat menampung parameter
    ...
    @NonNull
    @Override
    // perintaah pertama kali ketika perintah di buat
    public Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        // memberi tahu kepada adapter untuk menggunakan view
    ...
    // Mengubah nama buah sesuai dengan data yang kita miliki
        ...
        // Menampilkan gambar demgam data gambar yang kita miliki menggunakan library Glide
        Glide.with(context).load(gambarBuah[i]).into(viewHolder.imgNamaBuah);

        //Membuat button onCLik
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        // mengoneksikan widget ke dalam adapter
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            // Mengisi/ menghubungkan widget ke dalam variable yang sudah dibuat di atas
